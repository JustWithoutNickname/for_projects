...
args = {"labels" : "C:\\Users\\User\\PycharmProjects\PythonStading\coco_labels.txt",
		...
		"image" : "C:\\Users\\User\\PycharmProjects\PythonStading\pictureOne.jpg",
...
for i in range(0, len(r["scores"])):
	...
	cropped = image[startY - startY // 5 : endY + (image.shape[0] - endY) // 5, startX - startX // 5 : endX + (image.shape[1] - endX) // 5]
	#print("stY", startY, "stX", startX, "endX", endX, "endY", endY)
	cv2.imwrite("C:\\Users\\User\\PycharmProjects\\PythonStading\\results_of_predictions\\outpyt" + str(i) + ".jpg", cropped)
	"""classID = r["class_ids"][i]
